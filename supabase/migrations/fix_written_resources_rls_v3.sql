...
DROP POLICY IF EXISTS "admin_access_policy" ON written_resources;
DROP POLICY IF EXISTS "public_read_policy" ON written_resources;

-- Enable RLS
ALTER TABLE written_resources ENABLE ROW LEVEL SECURITY;

-- Create a simple admin policy with proper type handling
